...
export function createToolsDock(app, theme) {
  ...
  // Default ON, like the reference USD_Viewer: the two checkboxes control the
  // mechanism overlays directly, not hidden secondary buttons.
  togShowJoints.cb.checked = true;
  togShowLoops.cb.checked = true;
