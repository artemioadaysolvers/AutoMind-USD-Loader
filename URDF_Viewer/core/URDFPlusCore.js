...
function parseJoint(jointNode, model) {
  ...
  const j = {
    ...
    axis, axisJoint: [axis.x, axis.y, axis.z], axisWorldMeta: parseVec(attrAny(jointNode, ['automind:axis_world','axis_world','automind:axisWorld','axisWorld'], ''), null), axisJointMeta: parseVec(attrAny(jointNode, ['automind:axis_joint','axis_joint','automind:axisJoint','axisJoint'], ''), null), axisToken: 'X',
