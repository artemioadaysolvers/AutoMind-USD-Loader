...
async function makeMaterial(def, assetDB, geomNode = null) {
  ...
  if (map) {
    ...
    const solidColor = usesSolidTextureColor ? new THREE.Color(flat[0], flat[1], flat[2]) : new THREE.Color(0xffffff);
    ...
    mat = new THREE.MeshBasicMaterial({
      color: solidColor,
      map: usesSolidTextureColor ? null : map,
