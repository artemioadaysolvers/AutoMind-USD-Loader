...
// BUILD175: collision-safe MJCF visuals + stable textured viewport.
...
export function render(opts = {}) {
  ...
  // A fresh viewer always begins in opaque Solid mode. Ghost/X-Ray are explicit
  // user choices; starting transparent is especially harmful for CAD meshes.
  core.__currentRenderMode = 'Solid';
  let robot = null;
